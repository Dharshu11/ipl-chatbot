...
API_KEY = "yd3yBxSV9mSvJiF4ksJ1QXaXWtf2"
...
class ApiAction(Action):
	...
	def run(self, dispatcher, tracker, domain):
		...
		if res.status_code == 200:
			...
			out_message = "The match between {} and {} was recently held and {} won.".format(recent_match["team-1"], recent_match["team-2"], recent_match["winner_team"])
